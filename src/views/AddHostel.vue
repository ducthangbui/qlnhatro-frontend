        ...
        <v-layout>
          <v-flex>
            <v-card class="elevation-1 pa-3">
              ...
              <v-flex>
                <v-text-field label="Giá phòng" v-model="price" prefix="$" type="decimals" suffix="/tháng"></v-text-field>
              </v-flex>
              <v-flex>
                <v-text-field label="Giá điện" v-model="electricprice" prefix="$"  suffix="/số"></v-text-field>
              </v-flex>
              <v-flex>
                <v-text-field label="Giá nước" v-model="waterprice" prefix="$"  suffix="/tháng"></v-text-field>
              </v-flex>
              <v-flex>
                <v-text-field label="Chi phí bảo vệ" v-model="securitycost" prefix="$" suffix="/tháng"></v-text-field>
              </v-flex>
              <v-flex>
                <v-text-field label="Chi phí vệ sinh" v-model="sanitationcost" prefix="$" suffix="/tháng"></v-text-field>
              </v-flex>
              <v-flex>
...
export default {
  data () {
    return {
      haslandlord: null,
      regions: [
        'ĐH Quốc Gia', 'Bách-Kinh-Xây', 'Chợ Xanh', 'Chợ Phùng Khoang',
        'BV Thanh Nhàn', 'BV Bạch Mai', 'DH Kinh tế-Kỹ thuật'
      ],
      region: ['ĐH Quốc Gia'],
      adds: [
        'Quận Thanh Xuân', 'Quận Hoàng Mai', 'Quận Hà Đông', 'Quận Cầu Giấy'
      ],
      add: 'Quận Hoàng Mai',
      imageName: '',
      imageUrl: '',
  ...
  methods: {
    ...
    addEvent() {
      ...
      axios
        .post("http://203.162.88.120:443/api/hostel/addHostel?token=" + token, data, {
